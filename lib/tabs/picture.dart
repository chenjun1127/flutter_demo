...
import 'package:flutter_demo/utils/ImageWidget.dart';
...
class PictureState extends State<Picture> {
  ...
  void getData() async {
    var res = await HttpUtil.get(url: 'https://pic.sogou.com/pics/json.jsp', data: {"query": query, "start": page, "xml_len": count});
          ...
          RefreshIndicator(
              child: CustomScrollView(
                ...
                slivers: [
                  ...
                  SliverToBoxAdapter(child: Padding(padding: EdgeInsets.symmetric(vertical: 20), child: Visibility(child: Loading(), visible: isLoading)))
                ],
              ),
          ...
          Positioned(
              ...
              child: TextButton(
                ...
                style: ButtonStyle(
                    ...
                    shape: MaterialStateProperty.all(RoundedRectangleBorder(side: BorderSide.none, borderRadius: BorderRadius.all(Radius.circular(50))))),
                onPressed: () {
                  setState(() {
                    query = queryArr[Random().nextInt(queryArr.length)];
                    page = 0;
